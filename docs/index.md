...
Daryaft is a modern terminal downloader written in Go. **`v1.12.0` is the
...
- [v1.12.0 Release Notes](operations/release-notes-v1.12.0.md): stable release notes for `v1.12.0` — TUI download input UX polish.
