...
Daryaft `v1.7.0` is the current stable release. Install via Homebrew or
download binary archives directly from the
[GitHub releases page](https://github.com/he8um/daryaft/releases/tag/v1.7.0).
...
Source builds report version `1.8.0-dev`, commit `local`, build date
...
`1.8.0-dev-SNAPSHOT-<short-commit>`, and snapshot artifacts are written under
