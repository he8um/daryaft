...
Daryaft `v1.2.0` is the current stable release. Install via Homebrew or
...
Source builds report version `1.3.0-dev`, commit `local`, build date
...
`1.3.0-dev-SNAPSHOT-<short-commit>`, and snapshot artifacts are written under
