...
**`v1.12.0` is the current stable release.** `main` is now on `1.13.0-dev`
post-v1.12.0 development.
...
See [Daryaft v1.12.0 Release Notes](release-notes-v1.12.0.md) for the latest
stable release notes and known limitations. Earlier releases:
- [v1.11.0 Release Notes](release-notes-v1.11.0.md): read-only TUI Settings screen.
